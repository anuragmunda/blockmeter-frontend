    ...
    <main>
      <section className="bg-gray-100 p-4">
        <div className="border-3 border-indigo-500 rounded-lg grid grid-cols-1 justify-items-center gap-6 p-5 mb-10 font-[family-name:var(--font-geist-sans)]">
          ...
          <div className="min-w-full sm:min-w-auto text-white bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 flex flex-col items-center gap-3 justify-center border py-4 px-5 sm:px-10 rounded-lg shadow-lg">
      ...
      <section className="bg-gradient-to-r from-slate-900 to-slate-800 px-5 pt-6 flex flex-col items-center min-w-full">
      <span className="text-2xl text-white font-bold tracking-tight pb-1.5 border-b-6 border-b-indigo-500">FAQs</span>
        <FAQ />
      </section>
    </main>
  );
